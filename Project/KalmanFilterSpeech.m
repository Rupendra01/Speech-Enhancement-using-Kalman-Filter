...
% %sound(Output,Fs);
subplot(3,2,1)
plotWave_YW(0,Input,Fs,'time',1);
title('Clean speech')
subplot(3,2,2)
plotWave_YW(0,Input,Fs,'freq');

subplot(3,2,3)
plotWave_YW(0,NoisyInput,Fs,'time',1);
title('Noisy speech')
subplot(3,2,4)
plotWave_YW(0,NoisyInput,Fs,'freq');
